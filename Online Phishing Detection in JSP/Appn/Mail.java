...
public class Mail
{
	/**
	 ...
	 {
	 	Mail m=new Mail();
	 	m.send("rediffmail.com","vijayborwells@rediffmail.com","vijayborwells@rediffmail.com","tod","today"+"\n"+"fai","vijayborwells");
	 	m.receive("rediffmail.com","vijayborwells@rediffmail.com","vijayvijay");
